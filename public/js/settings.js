!function () {
    var t = {
        4963: function (t) {
            ...
            var r = n(3816), o = n(5645), i = n(7728), s = n(3415), a = n(741), c = "prototype", u = function (t, e, n) {
                var l, f, p, d, h = t & u.F, v = t & u.G, m = t & u.S, b = t & u.P, y = t & u.B, g = v ? r : m ? r[e] || (r[e] = {}) : (r[e] || {})[c], x = v ? o : o[e] || (o[e] = {}), S = x[c] || (x[c] = {});
            ...
            "use strict";
            var r = n(4461), o = n(2985), i = n(3415), s = n(7728), a = n(7234), c = n(9988), u = n(2943), l = n(468), f = n(6314)("iterator"), p = !([].keys && "next" in [].keys()), d = "keys", h = "values", v = function () {
                return this
            };
            t.exports = function (t, e, n, m, b, y, g) {
                ...
                }, k = e + " Iterator", O = b == h, j = !1, P = t.prototype, T = P[f] || P["@@iterator"] || b && P[b], _ = T || L(b), A = b ? O ? L("entries") : _ : void 0, C = "Array" == e && P.entries || T;
                if (C && (w = l(C.call(new t))) !== Object.prototype && w.next && (u(w, k, !0), r || "function" == typeof w[f] || s(w, f, v)), O && T && T.name !== h && (j = !0, _ = function () {
                    return T.call(this)
                }), r && !g || !p && !j && P[f] || s(P, f, _), a[e] = _, a[k] = v, b) if (x = {values: O ? _ : L(h), keys: y ? _ : L(d), entries: A}, g) for (S in x) S in P || i(P, S, x[S]); else o(o.P + o.F * (p || j), e, x);
                return x
            }
        }, 5436: function (t) {
            ...
            var r = n(3816), o = n(7728), i = n(9181), s = n(3953)("src"), a = n(18), c = "toString", u = ("" + a).split(c);
            ...
            !function (t) {
                "use strict";
                var e, r = /^[a-z]+:/, o = /[-a-z0-9]+(\.[-a-z0-9])*:\d+/i, i = /\/\/(.*?)(?::(.*?))?@/, s = /^win/i, a = /:$/, c = /^\?/, u = /^#/, l = /(.*\/)/, f = /^\/{2,}/, p = /(^\/?)/, d = /'/g, h = /%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi,
                    v = /%([cd][0-9a-f])%([89ab][0-9a-f])/gi, m = /%([0-7][0-9a-f])/gi, b = /\+/g, y = /^\w:$/, g = /[^/#?]/, x = "undefined" == typeof window && void 0 !== n.g && !0, S = !x && t.navigator && t.navigator.userAgent && ~t.navigator.userAgent.indexOf("MSIE"), w = x ? t.require : null,
                    L = {protocol: "protocol", host: "hostname", port: "port", path: "pathname", query: "search", hash: "hash"}, k = {ftp: 21, gopher: 70, http: 80, https: 443, ws: 80, wss: 443};
                ...
                function _(t, e) {
                    !function (t, e, n) {
                        ...
                        var v, m, b = (m = {path: !0, query: !0, hash: !0}, (v = e) && r.test(v) && (m.protocol = !0, m.host = !0, o.test(v) && (m.port = !0), i.test(v) && (m.user = !0, m.pass = !0)), m);
                        ...
                        if (t.protocol = t.protocol.replace(a, ""), t.query = t.query.replace(c, ""), t.hash = P(t.hash.replace(u, "")), t.user = P(h[1] || ""), t.pass = P(h[2] || ""), t.port = k[t.protocol] == t.port || 0 == t.port ? "" : t.port, !b.protocol && g.test(e.charAt(0)) && (t.path = e.split("?")[0].split("#")[0]), !b.protocol && n) {
                            var y = new _(O().match(l)[0]), j = y.path.split("/"), A = t.path.split("/"), C = ["protocol", "user", "pass", "host", "port"], q = C.length;
    ...
    n.n = function (t) {
        ...
        var t = n(7025);
        const e = new (n.n(t)()), r = "adminkit_config_", o = ".js-settings", i = {theme: "default", layout: "fluid", sidebarPosition: "left", sidebarLayout: "default"},
            s = {theme: ["default", "dark", "light", "colored"], layout: ["fluid", "boxed"], sidebarPosition: ["left", "right"], sidebarLayout: ["default", "compact"]};
        let a;
        const c = () => {
        ...
        }, v = () => ({theme: b("theme"), layout: b("layout"), sidebarPosition: b("sidebarPosition"), sidebarLayout: b("sidebarLayout")}), m = () => {
